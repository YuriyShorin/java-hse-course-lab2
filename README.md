The application allows you to calculate the frequency of repetition of each character in a file, as well as output this statistic to another file. Both files are specified by the user.
